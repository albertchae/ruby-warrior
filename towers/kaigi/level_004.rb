...
tip "Call warrior.bind!(direction) to bind an enemy to keep him from attacking. Bound enemies look like captives. You can walk!, attack! etc in multiple directions (:forward, :left, :right, :backward)"
